 ...
 */
class Version20140726164956 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE notifications (id VARCHAR(255) NOT NULL, user_id INT DEFAULT NULL, other_end_id INT DEFAULT NULL, content LONGTEXT NOT NULL COMMENT '(DC2Type:json_array)', is_read TINYINT(1) NOT NULL, action_id LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_6000B0D3A76ED395 (user_id), INDEX IDX_6000B0D3D3BBB008 (other_end_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE products (id VARCHAR(255) NOT NULL, user_id INT DEFAULT NULL, name LONGTEXT DEFAULT NULL, description LONGTEXT DEFAULT NULL, price NUMERIC(10, 2) DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_B3BA5A5AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE posts_images (id VARCHAR(255) NOT NULL, post_id VARCHAR(255) DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8A1D99C34B89032C (post_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE posts (id VARCHAR(255) NOT NULL, user_id INT DEFAULT NULL, video LONGTEXT DEFAULT NULL, content LONGTEXT DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_885DBAFAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
